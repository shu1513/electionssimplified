  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4 px-4 py-8 text-body leading-relaxed text-ink">
      ...
      <iframe
        ...
        loading="lazy"
        // The same frame embed.js draws on a publisher's page (1px brand red,
        // 8px corners), so the example looks exactly like the real thing.
        className="block h-[480px] w-full rounded-[8px] border border-rausch"
      />
      <p>
