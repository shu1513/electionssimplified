...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-page text-ink">
      ...
      {/* On "/" the header keeps its small corner logo like every other page
          but drops its border, so the white canvas runs unbroken from the
          top edge to the address field. */}
