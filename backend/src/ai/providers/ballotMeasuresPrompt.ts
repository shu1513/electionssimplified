...
export function buildBallotMeasuresPrompt(input: BallotMeasurePromptInput): string {
  ...
  return [
    ...
    "- Replace each legal or finance word with plain words, or explain it in a few words (binding arbitration -> a neutral third party decides; bond -> borrow; levy or millage -> property tax; ordinance -> city law).",
